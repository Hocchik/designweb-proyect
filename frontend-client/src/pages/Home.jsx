...
import Promos from '../components/Home/Bestsellingproducts';
import BestSellers from '../components/Home/ProductsbyCategory';
...
export default function Home() {
  ...
  return (
    <main className="pt-20 px-0.5 max-w-screen-xl mx-auto w-full">
            ...
            {nearestLocal ? (
              ...
              <>
                ...
                <button
                  ...
                  className="bg-red-600 hover:bg-red-600 text-white text-sm font-medium px-5 py-2 rounded-md transition"
                >
          ...
          {locales?.length > 0 && (
            <div className="w-full md:w-1/2">
              ...
              <select
                ...
                className="w-full border border-gray-300 text-gray-800 px-4 py-2 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600 transition"
              >
